...
const Checkout = () => {
  return (
    ...
    <form>
        <div className="space-y-12">
         <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-6">
    ...
    <div className="mx-auto mt-16 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl my-1 pb-2 text-left font-bold tracking-tight text-gray-900">Cart</h1>
